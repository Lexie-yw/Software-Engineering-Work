...
To implement a fun to use habit-forming application, we decided to add a Card Collecting Game (CCG) mechanism to the application to keep users engaged and motivated. Users who manage to track their goals and eventually achieve the goals will be rewarded with cards. The more goals they achieve, the more cards they will obtain and more likely to get all cards of a particular theme. The first theme of cards we implement is city views, which caters to our tagline: form your habits to build your little planet. A possible extension of the app would be turning the CCG game mechanism to a Trading and Collecting Game (TCG) game mechanism, allowing users to exchange cards they obtained.
